...
pet_message:        msg("The dungeon begins to rumble and shake!");
        ...
        break; case S_MAKEIT:
            ...
            if (blessed)
                ...
                switch (rnd(6)) {
                    case 0: item = RING;
                    break; case 1: item = POTION;
                    break; case 2: item = SCROLL;
                    break; case 3: item = ARMOR;
                    break; case 4: item = WEAPON;
                    break; case 5: item = STICK;
                }
                    ...
                    case RING:
                        ...
                        if (lb->o_ac > 5 && rnd(5) == 0) {
                            ...
                            switch(lb->o_which) {
                                ...
                                break; case R_ADDINTEL:
                                    pstats.s_intel -= 2;
                                    max_stats.s_intel -= 2;
                                break; case R_ADDWISDOM:
                                    pstats.s_wisdom -= 2;

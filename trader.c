...
typ_name(struct object *obj)
{
        ...
        switch (obj->o_type) {
                ...
                break; case SCROLL:  wh = TYP_SCROLL;
                break; case STICK:   wh = TYP_STICK;
                break; case RING:    wh = TYP_RING;
                break; case ARMOR:   wh = TYP_ARMOR;
                break; case WEAPON:  wh = TYP_WEAPON;
                break; case ARTIFACT:  wh = TYP_ARTIFACT;
                break; case FOOD:    wh = TYP_FOOD;
                break; default:    wh = -1;
        }
        if (wh < 0)
                strcpy(buff,"unknown");

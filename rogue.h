...
int roll_em(struct thing *att_er, struct thing *def_er,
	    struct object *weap, int hurl, struct object *cur_weapon);
int hung_dam(void);
...
int shoot_bolt(struct thing *shooter, coord start, coord dir,
	       int get_points, int reason, char *name, int damage);

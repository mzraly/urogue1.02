            ...
            if (fighting) {
                ...
                if ((winat(hero.y, hero.x) == PASSAGE) && off(player, ISHUH) &&
                    ...
                    switch (runch) {
                        ...
                        break; case 'j' : corr_move(1, 0);
                        break; case 'k' : corr_move(-1, 0);
                        break; case 'l' : corr_move(0, 1);
                    }
                ch = runch;
            }
...
#undef  UNCTRL
            ...
            switch (ch)
            {
                ...
                break; case 'H' : do_run('h');
                break; case 'J' : do_run('j');
                break; case 'K' : do_run('k');
                break; case 'L' : do_run('l');
                break; case 'Y' : do_run('y');
                break; case 'U' : do_run('u');
                break; case 'B' : do_run('b');
                break; case 'N' : do_run('n');
                break; case 'm':
                    moving = TRUE;
                    if (!get_dir()) {
                        after = FALSE;
                ...
                break; case 'Q' : after = FALSE; quit(0);
                break; case 'i' : after = FALSE; inventory(pack, 0);
                break; case 'I' : after = FALSE; picky_inven();
                break; case 'd' : drop(NULL);
                break; case 'q' : quaff(-1, FALSE);
                break; case 'r' : read_scroll(-1, FALSE);
                break; case 'e' : eat();
                break; case '=' : listenfor();
                break; case 'A' : apply();
                break; case 'w' : wield();
                break; case 'W' : wear();
                ...
                break; case 'o' : option(); fd_data[1].mi_name = fruit;
                break; case 'c' : call(FALSE);
                break; case 'M' : call(TRUE);
                ...
                break; case 'D' : dip_it();
                break; case 'G' : gsense();
                break; case '^' : set_trap(&player, hero.y, hero.x);
                break; case 's' : search(FALSE);
                break; case 'z' :
                    if (get_dir())
                        do_zap(TRUE, 0, FALSE);
                    else
                ...
                break; case 'v' : after = FALSE;
                           msg("UltraRogue Version %s.",
                                release);
                break; case CTRL('R') : after = FALSE; clearok(curscr, TRUE);
                ...
                break; case '.' : ;                     /* Rest command */
                break; case ' ' : after = FALSE;        /* Do Nothing */
                break; case CTRL('W') :
                    after = FALSE;
                    if (wizard)
                    {
                ...
                break; default:
                    ...
                    if (wizard) switch (ch)
                    {
                        ...
                        break; case CTRL('Z') : whatis(NULL);
                        break; case CTRL('D') : msg("rnd(4)%d, rnd(40)%d, rnd(100)%d",
                                                rnd(4),rnd(40),rnd(100));
                        break; case CTRL('F') : overlay(stdscr,cw);
                        break; case CTRL('M') : overlay(mw,cw);
                        break; case CTRL('X') : teleport();
                        break; case CTRL('E') : msg("food left: %d\tfood level: %d",
                                                food_left, foodlev);
                        break; case '@' : activity();
                        break; case CTRL('G') :
                        {
...
identify(void)
{
    ...
    else switch(ch)
    {
        ...
        break; case VPLAYER:    str = "The hero of the game ---> you";
        break; case IPLAYER:    str = "you (but invisible)";
        break; case PASSAGE:    str = "passage";
        break; case POST:       str = "trading post";
        break; case POOL:       str = "a shimmering pool";
        break; case TRAPDOOR:   str = "trapdoor";
        break; case ARROWTRAP:  str = "arrow trap";
        break; case SLEEPTRAP:  str = "sleeping gas trap";
        break; case BEARTRAP:   str = "bear trap";
        break; case TELTRAP:    str = "teleport trap";
        break; case DARTTRAP:   str = "dart trap";
        break; case MAZETRAP:   str = "entrance to a maze";
        break; case FIRETRAP:  str = "fire trap";
        break; case POISONTRAP:str = "poison pool trap";
        break; case LAIR:       str = "monster lair entrance";
        break; case RUSTTRAP:  str = "rust trap";
        ...
        break; case ARTIFACT:   str = "an artifact from bygone ages";
        break; case RING:       str = "ring";
        break; case STICK:      str = "wand or staff";
        break; default: str = "unknown character";
    }

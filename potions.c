        ...
        break; case P_ABIL: {
                ...
                /* probably will be own ability */
                    ...
                    if (rnd(100) < 10)
                        ...
                        break; case C_MAGICIAN: add_intelligence(cursed);
                        break; case C_CLERIC:   add_wisdom(cursed);
                        break; case C_THIEF:    add_dexterity(cursed);
                        break; default: msg("You're a strange type!");
                    }
                }

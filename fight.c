...
check_level(void)
{
    ...
    if (++i > pstats.s_lvl) {
        switch (player.t_ctype) {
            ...
            break; case C_MAGICIAN:     nsides = 4;
            break; case C_CLERIC:       nsides = 8;
            break; case C_THIEF:        nsides = 6;
        }
...
hit(char *er, char *ee)
{
    ...
    if (terse)
        ...
        switch (rnd(4))
        {
            ...
            break; case 1: s = " hit ";
            break; case 2: s = (er == 0 ? " have injured " : " has injured ");
            break; case 3: s = (er == 0 ? " swing and hit " : " swings and hits ");
        }
    addmsg(s);
    if (!terse)
...
miss(char *er, char *ee)
{
    ...
    switch (terse ? 0 : rnd(4))
    {
        ...
        break; case 1: s = (er == 0 ? " swing and miss" : " swings and misses");
        break; case 2: s = (er == 0 ? " barely miss" : " barely misses");
        break; case 3: s = (er == 0 ? " don't hit" : " doesn't hit");
    }
    addmsg(s);
    if (!terse)
...
hung_dam(void)
{
        ...
        switch(hungry_state) {
                ...
                break; case F_WEAK:     howmuch = -1;
                break; case F_FAINT:    howmuch = -2;
        }
        return howmuch;
}

...
struct init_weps weaps[MAXWEAPONS] = {
    ...
    { "sling bullet", "1d1", "1d8", SLING, ISMANY | ISMISL | ISMETAL, 3,
     1 },
    ...
    { "boomerang", "1d1", "1d8", NONE, CANRETURN | ISMANY | ISMISL, 10,
     3 },
    { "burning oil", "0d0", "2d10+5", NONE, CANBURN | ISMANY | ISMISL, 20,
     3 },

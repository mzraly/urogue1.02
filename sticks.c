            ...
            if ( x >= 0 && x < COLS && y >= 1 && y < LINES - 2 &&
                ...
                if (which == WS_POLYMORPH) {
                    ...
                    if (cursed) {       /* Teleport monster to player */
                        ...
                        } while(winat(tp->t_pos.y,tp->t_pos.x) != FLOOR && i++ <= 500);
                    }
